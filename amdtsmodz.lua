...
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local EffectConiner = ReplicatedStorage:FindFirstChild("Effect") and ReplicatedStorage.Effect:FindFirstChild("Container")
...
Window = Fluent:CreateWindow({
    Title = "Chuối Cặc Hub - Blox Fruit",
    SubTitle = "By AmdtsModz ",
    TabWidth = 155,
...
LGa:AddButton({
    Title = "Rain Fruit",
    Callback = function()
        local fruitObjects = game:GetObjects("rbxassetid://101619474894641")[1]:GetChildren()
        local maxFruits = 10
        local count = 0
...
Button.Image = "rbxassetid://101619474894641"
